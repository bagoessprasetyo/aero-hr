  ...
  return (
    <div className="flex items-center justify-center py-12">
      <div className="flex items-center space-x-3">
        ...
        <span className="text-muted-foreground">Loading position management...</span>
      </div>
    </div>
  )
}
...
export default function PositionsPage() {
  ...
  return (
    // <ProtectedRoute permission="admin.positions.read">
      <div className="container mx-auto py-6 space-y-6">
        <AdminBreadcrumb 
          items={[
            { label: 'Position Management', current: true }
          ]}
